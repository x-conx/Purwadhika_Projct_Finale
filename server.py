...
# load dataset
df = sb.load_dataset('CreditCardDataset_cleaned.csv')

# # # # # # # # # # # #
# # HISTOGRAM & BOX # #
# # # # # # # # # # # #

def category_plot(cat_plot = 'histoplot', cat_x = 'Average_Balance', cat_y = 'Credit_Rating', estimator ='count', hue='Offer_Accepted'):
